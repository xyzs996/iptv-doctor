...
Set `NPM_TOKEN` in repository secrets. The publish workflow runs `npm publish` through pnpm for `iptv-doctor`, `iptv-doctor-core`, `iptv-sports-data`, and `@bjia666/match2epg`.
