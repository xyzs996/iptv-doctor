...
- AI coding field notes — write-ups on what AI coding agents actually cost, and a dataset of every figure they cite, each row kept with the sentence it was published in. https://xyzs996.github.io/llm-api-pricing/llms.txt`;
}
